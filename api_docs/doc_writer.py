...
class HydraDoc():
    ...
    def generate(self):
        ...
        doc = {
            ...
            "supportedClass": [x.generate() for x in self.parsed_classes + self.other_classes + self.collections],
...
class HydraClass():
    ...
    def __init__(self, id_, title, desc, sub_classof=None, endpoint=False):
...
class HydraEntryPoint():
    ...
    def __init__(self, url):
        ...
        self.supportedOperation = [EntryPointOp("_:entry_point", "GET", "The APIs main entry point.", None, None, "vocab:EntryPoint")]
        self.supportedProperty = list()
    ...
    def add_Class(self, class_):
        ...
        self.supportedProperty.append(entrypoint_class)

    def add_Collection(self, collection):
        """Add supportedProperty to the EntryPoint."""
        entrypoint_collection = EntryPointCollection(collection)
        self.supportedProperty.append(entrypoint_collection)

    def generate(self):
        """Get as a Python dict."""
        self.entrypoint.generate()
...
class EntryPointClass():
    ...
    def generate(self):
        ...
        for op in self.supportedOperation:
            ...
            object_["supportedOperation"].append(operation)
        return object_
