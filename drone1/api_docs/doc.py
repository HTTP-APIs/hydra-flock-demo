                          ...
                          {'@id': 'vocab:Drone',
                           ...
                           'description': 'Class for a drone',
                              'supportedOperation': [{'@type': 'hydra:Operation',
                                                      'expects': None,
                                                      'method': 'GET',
                                                      'possibleStatus': [{'description': 'Status Returned',
                                                                          'statusCode': 200}],
                                                     ...
                                                     {'@type': 'hydra:Operation',
                                                      ...
                                                      'method': 'POST',
                                                      'possibleStatus': [{'description': 'Command issued',
                                                                          'statusCode': 200}],
                                                      'returns': None,
                                                      'title': 'IssueCommand'}],
                              'supportedProperty': [{'@type': 'SupportedProperty',
                          ...
                          {'@id': 'vocab:EntryPoint',
                           ...
                           'description': 'The main entry point or homepage of the API.',
                              'supportedOperation': [{'@id': '_:entry_point',
                                                      ...
                                                      'statusCodes': []}],
                              'supportedProperty': [{'hydra:description': 'The Drone Class',
                                                     'hydra:title': 'drone',
                                                     'property': {'@id': 'vocab:EntryPoint/Drone',
                                                                  '@type': 'hydra:Link',
                                                                  'description': 'Class for a drone',
                                                                  'domain': 'vocab:EntryPoint',
                                                                           'label': 'Drone',
                                                                           'range': 'vocab:Drone',
                                                                           'supportedOperation': [{'@id': '_:getstatus',
                                                                                                   '@type': 'hydra:Operation',
                                                                                                   'description': None,
                                                                                                   'expects': None,
                                                                                                   'label': 'GetStatus',
                                                                                                   'method': 'GET',
                                                                                                   'returns': 'vocab:Status',
                                                                                                   'statusCodes': [{'description': 'Status Returned',
                                                                                                                    'statusCode': 200}]},
                                                                                                  {'@id': '_:issuecommand',
                                                                                                   '@type': 'hydra:Operation',
                                                                                                   'description': None,
                                                                                                   ...
                                                                                                   'method': 'POST',
                                                                                                   'returns': None,
                                                                                                   'statusCodes': [{'description': 'Command issued',
                                                                                                                    'statusCode': 200}]}]},
                                                     'readonly': True,
                                                     'required': None,
                                                     'writeonly': False},
                                                    {'hydra:description': 'The Data Class',
                                                     'hydra:title': 'data',
                                                     'property': {'@id': 'vocab:EntryPoint/Data',
                                                                  '@type': 'hydra:Link',
                                                                  'description': 'Class for a data entry',
                                                                  'domain': 'vocab:EntryPoint',
                                                                  'label': 'Data',
                                                                           'range': 'vocab:Data',
                                                                           'supportedOperation': [{'@id': '_:getdata',
                                                                                                   '@type': 'hydra:Operation',
                                                                                                   'description': None,
                                                                                                   'expects': None,
                                                                                                   'label': 'GetData',
                                                                                                   'method': 'GET',
                                                                                                   'returns': 'vocab:Data',
                                                                                                   'statusCodes': [{'description': 'Data not found',
                                                                                                                    'statusCode': 404},
                                                                                                                   {'description': 'Data returned',
                                                                                                                    'statusCode': 200}]}]},
                                                     'readonly': True,
